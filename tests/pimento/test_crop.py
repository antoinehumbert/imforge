...
class TestCrop:
    ...
    def test_crop_2(self, resources):
        expected_result = resources / "pimento" / "crop" / "expected" / "crop_2.jpg"
    ...
    def test_crop_3(self, resources):
        expected_result = resources / "pimento" / "crop" / "expected" / "crop_3.jpg"
    ...
    def test_crop_4(self, resources):
        expected_result = resources / "pimento" / "crop" / "expected" / "crop_4.jpg"
    ...
    def test_crop_flip_1(self, resources):
        expected_result = resources / "pimento" / "crop" / "expected" / "crop_flip_1.jpg"
    ...
    def test_crop_flip_2(self, resources):
        expected_result = resources / "pimento" / "crop" / "expected" / "crop_flip_2.jpg"
    ...
    def test_crop_flip_3(self, resources):
        expected_result = resources / "pimento" / "crop" / "expected" / "crop_flip_3.jpg"
    ...
    def test_crop_flip_4(self, resources):
        expected_result = resources / "pimento" / "crop" / "expected" / "crop_flip_4.jpg"
    ...
    def test_crop_fill(self, resources):
        expected_result = resources / "pimento" / "crop" / "expected" / "crop_fill.jpg"
        crop_box = [(15, 8), (368, 78), (325, 161), (14, 71)]
        with Image.open(resources / "some_text.jpg") as image:
    ...
    def test_crop_cut_out(self, resources):
        expected_result = resources / "pimento" / "crop" / "expected" / "crop_cut_out.jpg"
        crop_box = [(15, 8), (368, 78), (325, 161), (14, 71)]
        with Image.open(resources / "some_text.jpg") as image:
    ...
    def test_crop_cut_out_fill(self, resources):
        expected_result = resources / "pimento" / "crop" / "expected" / "crop_cut_out_fill.jpg"
        crop_box = [(15, 8), (368, 78), (325, 161), (14, 71)]
        with Image.open(resources / "some_text.jpg") as image:
    ...
    def test_crop_out_of_image(self, resources):
        expected_result = resources / "pimento" / "crop" / "expected" / "crop_out_of_image.jpg"
    ...
    def test_crop_out_of_image_clip(self, resources):
        expected_result = resources / "pimento" / "crop" / "expected" / "crop_out_of_image_clip.jpg"
        crop_box = [(-15, 0), (368, 78), (325, 161), (14, 71)]
        with Image.open(resources / "some_text.jpg") as image:
    ...
    def test_crop_flip_out_of_image_clip(self, resources):
        expected_result = resources / "pimento" / "crop" / "expected" / "crop_flip_out_of_image_clip.jpg"
    ...
    def test_crop_complex(self, resources):
        expected_result = resources / "pimento" / "crop" / "expected" / "crop_complex.jpg"
    ...
    def test_crop_flip_complex(self, resources):
        expected_result = resources / "pimento" / "crop" / "expected" / "crop_flip_complex.jpg"
